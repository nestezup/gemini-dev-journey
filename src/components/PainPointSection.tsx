    ...
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center break-words">
          <h2 className="text-3xl md:text-4xl font-bold mb-16 text-foreground break-words">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {painPoints.map((point, index) => (
              <div key={index} className="bg-card p-8 rounded-xl shadow-soft border border-border/50 hover:shadow-medium transition-all duration-300 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-foreground break-words">{point.title}</h3>
